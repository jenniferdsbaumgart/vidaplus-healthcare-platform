...
const DashboardLayout = () => {
  ...
  ? [
      ...
      { name: 'Telemedicina', path: '/telemedicine', icon: <Video className="h-5 w-5" /> },
    ]
  : [
      { name: 'Dashboard', path: '/dashboard', icon: <Home className="h-5 w-5" /> },
      { name: 'Pacientes', path: '/patients', icon: <Users className="h-5 w-5" /> },
      { name: 'Equipe Médica', path: '/staff', icon: <Stethoscope className="h-5 w-5" /> },
      { name: 'Telemedicina', path: '/telemedicine', icon: <Video className="h-5 w-5" /> },
      { name: 'Relatórios', path: '/reports', icon: <BarChart className="h-5 w-5" /> },
    ];
