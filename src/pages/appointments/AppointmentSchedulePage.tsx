...
const AppointmentSchedulePage = () => {
  ...
  useEffect(() => {
    const loadStaff = async () => {
      try {
        ...
        setStaff(data.filter((member: Staff) => member.role === "doctor"));
        setError(null);
      } catch (err) {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (!user?.patientId) {
        setError("Usuário não possui patientId vinculado.");
        return;
      }
              ...
              <CardContent className="space-y-6">
                ...
                <div className="flex space-x-4">
                  <Button
                    type="button"
                    variant={
                      appointmentType === "presential" ? "primary" : "outline"
                    }
                  ...
                  <Button
                    type="button"
                    variant={
                      appointmentType === "virtual" ? "primary" : "outline"
                    }
